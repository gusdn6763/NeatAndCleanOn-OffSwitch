...
public class SwitchEditorInspector : Editor
{
    ...
    SerializedProperty m_OnSwitchColor;
    SerializedProperty m_OffSwitchColor;
    ...
    SerializedProperty m_OnButtonColor;
    SerializedProperty m_OffButtonColor;

    SerializedObject buttonSize;
    SerializedProperty m_Button_SizeDelta;
    SerializedProperty m_Button_Pos;
    SerializedProperty m_Button_StartPos;
    ...
    void OnEnable()
    {
        ...
        m_OnSwitchColor = serializedObject.FindProperty("onBackgroundColor");
        m_OffSwitchColor = serializedObject.FindProperty("offBackgroundColor");
        ...
        m_OnButtonColor = serializedObject.FindProperty("onSwitchColor");
        m_OffButtonColor = serializedObject.FindProperty("offSwitchColor");
        ...
        m_Button_StartPos = serializedObject.FindProperty("buttonStartPosTmp");
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (switchButtonBackground = EditorGUILayout.Foldout(switchButtonBackground, "Swtich", EditorStyles.boldFont))
        {
            ...
            EditorGUILayout.PropertyField(m_OnSwitchColor, new GUIContent("OnColor"));
            EditorGUILayout.PropertyField(m_OffSwitchColor, new GUIContent("OffColor"));
            ...
            if (GUILayout.Button("Reset", GUILayout.MinHeight(35), GUILayout.MinWidth(40), GUILayout.MaxWidth(60)))
            {
                ...
                _editor.switchRectTr.localScale = new Vector3((float)switchScaleTmp, (float)switchScaleTmp, (float)switchScaleTmp);
            }
        ...
        if (switchButton = EditorGUILayout.Foldout(switchButton, "SwitchButton"))
        {
            ...
            EditorGUILayout.PropertyField(m_OnButtonColor, new GUIContent("OnColor"));
            EditorGUILayout.PropertyField(m_OffButtonColor, new GUIContent("OffColor"));
            ...
            EditorGUILayout.PropertyField(m_Button_StartPos, new GUIContent("ButtonStartPos"));
            GUILayout.EndVertical();

            if (GUILayout.Button("Reset", GUILayout.MinHeight(35), GUILayout.MinWidth(40), GUILayout.MaxWidth(60)))
            {
                _editor.button.sizeDelta = (Vector2)buttonSizeTmp;
                _editor.buttonStartPosTmp = (float)buttonStartPosTmp;
            }
            EditorGUILayout.EndHorizontal();
    ...
    public void CheckInfo()
    {
        ...
        if (buttonStartPosTmp == null) buttonStartPosTmp = _editor.buttonStartPosTmp;
